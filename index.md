[![Tchelinux 2019 Rio Grande](images/banner.jpg)](#)
...
| <center> Horário </center> | <center> Sala 1 <br> Desenvolvimento </center> | <center> Sala 2 <br> Big Data, IA, Web e DevOps </center> | <center> Sala 3 <br> Segurança, Sysadmin e Comunidade </center> |
|:--------------------------:|:-----------------------:|:-----------------------:|:-----------------------:|
...
[Rafael Guterres Jeffman](https://github.com/rafasgj) é Rafael Jeffman é fotógrafo, impressor e professor universitário. Leciona as disciplinas de algoritmos, estruturas de dados e desenvolvimento de jogos. Colaborou por anos com a distribuição GoboLinux. Entre seu projetos atuais, está um sistema de gerenciamento de ativos digitais multiplataforma, open source.
...
### "Offlinerização": Removendo o requisito de conectividade com a Internet para serviços de TI 

Esta palestra tem como objetivo apresentar uma solução, baseada em tecnologias de conteinerização, que permite a sincronização de dados entre serviços que necessitem de conectividade com a Internet, ainda que tais serviços sejam implantados em locais onde não existe uma conexão estável, ou onde simplesmente não exista tal conexão ("offlinerização"). Tal solução, foi desenvolvida no contexto do projeto AVAPolos, projeto de desenvolvimento tecnológico financiado pela CAPES e desenvolvido no Centro de Ciências Computacionais da FURG. Pretende-se apresentar os aspectos técnicos que viabilizaram a criação desta solução utilizando tecnologias de replicação de banco de dados (Postgres:BDR, Postgres:Bucardo, Mysql:replication), conteinerização (docker, docker-compose), sincronização de arquivos (rsync).  

### João Mateus Daltro de Athayde 

[João Mateus Daltro de Athayde](https://facebook.com/mateus.daltro/) é desenvolvedor do quadro permanente do Centro de Ciências Computacionais da FURG onde mantém e desenvolve sistemas informatizados desde 2014. Anteriormente atuou por 2 anos como desenvolvedor na Marinha da Brasil. Possui graduação em Tecnologia em Gestão Pública pelo Centro Universitário de Maringá, é Técnico em Informática pelo Instituto Federal da Bahia (IFBA), e formando do curso de Sistemas de Informação da FURG. 
...
### Utilizando tecnologias de conteinerização na gestão de recursos de tecnologia da informação em instituição pública: uma visão prática.

Um dos gargalos normalmente encontrado em instituições públicas é a quantidade limitada de recursos de tecnologia da informação, especificamente poder de processamento, armazenamento e memória, frente a crescente necessidade de recursos computacionais. Agrava este cenário, o fato que estes recursos estão fisicamente distribuídos em uma diversidade de equipamentos (PCs), dificultando assim a otimização da utilização destes recursos, e mesmo de sua administração. Esta palestra tem como objetivo fornecer aos ouvintes uma visão prática de como as tecnologias de conteinerização podem ajudar a otimizar tais recursos, viabilizar a implantação de novos serviços, e reduzir o tempo e o esforço técnico necessários para a implantação e manutenção destes serviços. Mais especificamente, como o Centro de Ciências Computacionais (C3) da FURG, pretende utilizar softwares como Docker, Kubernetes entre outros, na gestão de seus recursos de TI. Além disso, compartilhar também as experiências obtidas na utilização de tais tecnologias no contexto do projeto AVAPolos, projeto de desenvolvido tecnológico, financiado pela CAPES e desenvolvido no C3. 

### Rafael Vianna Oliveira 

[Rafael Vianna Oliveira](https://www.facebook.com/rafael.viannaoliveira) é responsável técnico pela infraestrutura de TI do Centro de Ciências Computacionais da FURG desde 2013. Possui experiência de mais de 15 anos trabalhando na gestão e coordenação de TI em instituições públicas. Como formação, é tecnólogo em Gestão Pública, técnico em Processamento de Dados e formando no curso de bacharelado em Sistemas de Informação da FURG. 
...
### Linux Para Escritores 

O objetivo da palestra é apresentar ferramentas e meios de trabalho para escritores que sejam usuários de software livre ou que desejam migrar para a iniciativa open source, e demostrar a ampla capacidade dos programas de código aberto em áreas diferenciadas, como a literatura.
...
Hoje todos sabem que as metodologias ágeis fazem parte do dia-a-dia das grandes empresas. O Scrum, por exemplo, é amplamente utilizado. No entanto, os métodos ágeis vão muito além do Scrum, e são exatamente estes outros métodos que quero abordar, como: Story points, User stories, MVP, Kanban, entre outros. 

### Rodrigo Ferro 

[Rodrigo Ferro](https://medium.com/@roferro/) é formado em Análise de Sistemas pela Faculdade Senac Pelotas, em Tecnologia da Informação no Muscatine Community College (EUA) e possui MBA em Gestão de Projetos pela Anhanguera Pelotas. Atua há mais de 6 anos como gerente de projetos de produtos digitais e há mais de 4 anos commétodos ágeis. Trabalhou em mais de 100 projetos nacionais e internacionais, para clientes como Siemens, Positivo, Yázigi, Deutsche Bank, DLL, entre outros. Atualmente é Gerente de Projetos na Main Leaf, empresa de outsourcing especializada em desenvolvimento Unity, atuando remotamente de Pelotas gerenciando projetos internacionais para clientes dos Estados Unidos, Canadá, Dubai, Inglaterra, entre outros.
